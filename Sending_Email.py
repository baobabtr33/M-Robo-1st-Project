...
def sendMail(my_email, recipient_email, msg, feed_num):
  """
  ...
  """
    ...
    #이메일 IMAGE
    img1_path = 'db/chart/' + feed_num + '-chart'
    img2_path =  'db/chart/' + feed_num + '-bar'
    pngfiles = [img1_path, img2_path]
    filename = ['Chart', 'Bar']
    for i in range(0,2):
      ...
      img.add_header(filename[i] , 'attachment', filename=file)
      msg.attach(img)
